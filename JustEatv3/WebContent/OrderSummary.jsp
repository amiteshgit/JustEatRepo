...
counter1++;
			%>
					...
					<%--<a class="accordion-section-title" href="#accordion-<%=counter1%>-<%=counter2%>"> --%>
						<a class="accordion-section-title" href="javascript:showHideAcc('accordion-<%=counter1%>')">
						<table  width="100%">
							<tr>
								<td width="34%" align="left">Vendor Name:&nbsp;<%=rs.getString(1)%></td>
								
								<td width="33%">Status:&nbsp;<%=rs.getString(2)%></td>
								
								<td width="33%" align="right">Expected time of delivery:&nbsp;<%=rs.getString(4)%></td>
						...
						<div id="accordion-<%=counter1%>" style="display:none" class="accordion-section-content">
<%
						ResultSet rs1 = null;
